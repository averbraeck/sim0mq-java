 ...
 * collectors, etc. It can start a federation as soon as all required model components are on-line. It might kill model
 * components that take too long to finish.
 * <p>
