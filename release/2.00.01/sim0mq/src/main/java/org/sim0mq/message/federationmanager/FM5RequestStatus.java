...
public class FM5RequestStatus extends Sim0MQMessage
{
    ...
    public FM5RequestStatus(final Object federationId, final Object senderId, final Object receiverId, final Object messageId)
    ...
    public static class Builder extends Sim0MQMessage.Builder<FM5RequestStatus.Builder>
    {
        ...
        {
            return new FM5RequestStatus(this.federationId, this.senderId, this.receiverId, this.messageId);
        }
