...
public class FM7SimResetMessage extends Sim0MQMessage
{
     ...
     */
    public FM7SimResetMessage(final Object federationId, final Object senderId, final Object receiverId, final Object messageId)
    ...
    public static class Builder extends Sim0MQMessage.Builder<FM7SimResetMessage.Builder>
    {
        ...
        {
            return new FM7SimResetMessage(this.federationId, this.senderId, this.receiverId, this.messageId);
        }
