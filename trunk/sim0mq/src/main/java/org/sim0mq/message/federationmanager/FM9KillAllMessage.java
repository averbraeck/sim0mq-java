...
public class FM9KillAllMessage extends Sim0MQMessage
{
     ...
     */
    public static FM9KillAllMessage createMessage(final Object[] fields, final Object intendedReceiverId) throws Sim0MQException
    {
        check(fields, 0, MESSAGETYPE, intendedReceiverId);
        return new FM9KillAllMessage(fields[1], fields[2], fields[3], ((Long) fields[5]).longValue());
    }
